...
<simconf>
  ...
  <simulation>
    ...
    <mote>
      ...
      <interface_config>
        ...
        <x>90.66311162579535</x>
        <y>18.91629198289619</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
    ...
    <mote>
      ...
      <interface_config>
        se.sics.cooja.interfaces.Position
        <x>49.147238370775426</x>
        <y>20.00274533723759</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        se.sics.cooja.mspmote.interfaces.MspMoteID
  ...
  <plugin>
    ...
    <plugin_config>
      ...
      <viewport>2.5431611795860642 0.0 0.0 2.5431611795860642 19.42909409279928 121.89282056738331</viewport>
    </plugin_config>
    <width>400</width>
    <z>1</z>
    <height>400</height>
